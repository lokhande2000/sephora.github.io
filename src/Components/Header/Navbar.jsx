  ...
  return (
    ...
    {/* <Flex gap={15}>
      ...
      <header>
        ...
        >
          ...
          <Flex alignItems={"center"}>
            <Image src='https://www.sephora.com/img/ufe/icons/stores.svg' alt="home img" w={8} />
            <Box ml={10}>
          ...
          <Flex>
            <Center>
              <Image src='https://www.sephora.com/img/ufe/icons/community.svg' alt="comunity img" w={8} />
          ...
          <Flex>
            <Center>
              <Image src="https://www.sephora.com/img/ufe/icons/me.svg" alt="image" w={8} />
              <Box ml={8}>
                <Text>
                  <Link>
      ...
      <div className="dropdown">
        <button className="dropbtn"><Link to="">New</Link></button>
      ...
      <div className="dropdown">
        <button className="dropbtn"><Link to="">Brands</Link></button>
        <div className="dropdown-content">
          <div className="row">
            <div className="column">
              <h3>Brands A-Z</h3>
      ...
      <div className="dropdown">
        <button className="dropbtn"><Link to="">Makeup</Link></button>
        <div className="dropdown-content">
          <div className="row">
            <div className="column">
            <Link to=""><b>All Makeup</b></Link>
              <Link to="">Face</Link>
            ...
            <div className="column">
              <Link to=""><b>Cheek</b></Link>
              <Link to="">Blush</Link>
              <Link to="">Bronzer</Link>
              <Link to="">Highlighter</Link>
              <Link to="">Contour</Link>
              <Link to="">Cheek Palettes</Link>
              <Link to=""><b>Value & Gift Sets</b></Link>
              <Link to=""><b>Makeup Palettes</b></Link>
              <Link to=""><b>Brushes & Applicators</b></Link>
              <Link to=""><b>Accessories</b></Link>
              <Link to=""><b>Nail</b></Link>
            </div>
            <div className="column">
              <Link to=""><b>New</b></Link>
              <Link to=""><b>Bestsellers</b></Link>
              <Link to=""><b>Clean Makeup</b></Link>
              <Link to=""><b>Vegan Makeup</b></Link>
              <Link to=""><b>Vegan Makeup</b></Link>
              <Link to=""><b>Mini Size</b></Link>
              <Link to=""><b>Value Size</b></Link>
              <Link to=""><b>Refillable Makeup</b></Link>
              <Link to=""><b>Sephora Collection</b></Link>
              <Link to=""><b>Luxury Makeup</b></Link>
              <Link to=""><b>Black-Owned Brands Makeup</b></Link>
            </div>
            <div className="column">
              <Link to=""><b>Help Me Choose</b></Link>
      ...
      <div className="dropdown">
        <button className="dropbtn"><Link to="">Skincare</Link></button>
        <div className="dropdown-content">
          <div className="row">
            <div className="column">
              <Link to=""><b>All Skincare</b></Link>
              <Link to=""><b>Moisturizers</b></Link>
              <Link to="">Night Creams</Link>
              <Link to="">Face Oils</Link>
              <Link to="">Mists & Essences</Link>
              <Link to="">BB & CC Cream</Link>
              <Link to=""><b>Cleansers</b></Link>
            ...
            <div className="column">
              <Link to=""><b>New</b></Link>
              <Link to=""><b>Bestsellers</b></Link>
              <Link to=""><b>Clean Skincare</b></Link>
              <Link to=""><b>Vegan Skincare</b></Link>
              <Link to=""><b>Value & Gift Sets</b></Link>
              <Link to=""><b>Mini Size</b></Link>
              <Link to=""><b>Mini Size</b></Link>
              <Link to=""><b>Refillable Skincare</b></Link>
              <Link to=""><b>FSA & HSA Eligible</b></Link>
              <Link to=""><b>Sephora Collection</b></Link>
              <Link to=""><b>Luxury Skincare</b></Link>
              <Link to=""><b>Black-Owned Brands Skincare</b></Link>
            </div>
            <div className="column">
              <Link to=""><b>Help Me Choose</b></Link>
      ...
      <div className="dropdown">
        <button className="dropbtn"><Link to="">Hair</Link></button>
        <div className="dropdown-content">
          <div className="row">
            <div className="column">
              <Link to=""><b></b></Link>
      ...
      <div className="dropdown">
        <button className="dropbtn"><Link to="">Fragrance</Link></button>
        <div className="dropdown-content">
          <div className="row">
            <div className="column">
              <Link to=""><b></b></Link>
      ...
      <div className="dropdown">
        <button className="dropbtn"><Link to="">Tools & Brushes</Link></button>
        <div className="dropdown-content">
          <div className="row">
            <div className="column">
              <Link to=""><b></b></Link>
      ...
      <div className="dropdown">
        <button className="dropbtn"><Link to="">Bath & Body</Link></button>
        <div className="dropdown-content">
          <div className="row">
            <div className="column">
              <Link to=""><b></b></Link>
      ...
      <div className="dropdown">
        <button className="dropbtn"><Link to="">Mini Size</Link></button>
        <div className="dropdown-content">
          <div className="row">
            <div className="column">
              <Link to=""><b></b></Link>
      ...
      <div className="dropdown">
        <button className="dropbtn"><Link to="">Gifts & Gift Cards</Link></button>
        <div className="dropdown-content">
          <div className="row">
            <div className="column">
              <Link to=""><b></b></Link>
      ...
      <div className="dropdown">
        <button className="dropbtn"><Link to="">Beauty Under $20</Link></button>
        <div className="dropdown-content">
          <div className="row">
            <div className="column">
              <Link to=""><b></b></Link>
      ...
      <div className="dropdown">
        <button className="dropbtn"><Link to="">Sale & Offers</Link></button>
        <div className="dropdown-content">
          <div className="row">
            <div className="column">
              <Link to=""><b></b></Link>
